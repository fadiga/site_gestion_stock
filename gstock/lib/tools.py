...
def get_time_pagination(request,year, duration,
    ...
    if duration == "week":
        ...
        current_date_ = str(ugettext("Week of")) + " " + format_date(current_date,ugettext("YYYY MMMM dd"))
        previous_date_ = str(ugettext("Week of")) + " " + format_date(previous_date,ugettext("YYYY MMMM dd"))
        next_date_ = str(ugettext("Week of")) + " " + format_date(next_date, ugettext("YYYY MMMM dd"))
